...
RUN conda install -c conda-forge "transformers>=4.38.0" "ffmpeg>=5" "pyarrow>=15" seaborn pandas shapely scikit-learn scikit-image dropbox pymssql h5py unidecode  \
