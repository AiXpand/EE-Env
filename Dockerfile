...
RUN conda install -c conda-forge "transformers>=4.34.0" seaborn pandas shapely scikit-learn scikit-image dropbox pymssql h5py unidecode "ffmpeg>=5" \
